...
/** CREDIT TO vivin, from StackOverflow. http://stackoverflow.com/questions/8286668/how-to-read-mnist-data-in-c
 */
public class LoadMNIST {
    ...
    public LoadMNIST(String labelFileName, String imageFileName) {
        this.labelFileName = labelFileName;
        this.imageFileName = imageFileName;
    }

    @SuppressWarnings("resource")
	public List<InputMNIST> load() throws IOException {
        List<InputMNIST> images = new ArrayList<InputMNIST>();
        ...
        int numberOfLabels = (ByteBuffer.wrap(Arrays.copyOfRange(labelBytes, NUMBER_ITEMS_OFFSET, NUMBER_ITEMS_OFFSET + ITEMS_SIZE)).getInt()/250);
        int numberOfImages = (ByteBuffer.wrap(Arrays.copyOfRange(imageBytes, NUMBER_ITEMS_OFFSET, NUMBER_ITEMS_OFFSET + ITEMS_SIZE)).getInt()/250);
        ...
        for(int i = 0; i < numberOfLabels; i++) {
            ...
            images.add(new InputMNIST(label, imageData));
        }
